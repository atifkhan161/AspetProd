...
(function ($, window, undefined) {
    ...
    $.nsWindow = {
        ...
        open: function (options) {
            ...
            if (opt.showControlBar == true) {
                ...
                if (_isEmpty(opt.closable) || opt.closable == true) {
                    t += '<a class="glyphicon glyphicon-remove-sign close" title="close" href="javascript:void(0)"></a>';
                }
                t += '</div>';
            }
            ...
            $('.close', this.window).click(function () {
                _IsBudgetDetail = false;
                self.close();
                if ($("#btnDialogClose") != undefined) {
                    var Me = $("#btnDialogClose")[0];
                    if (Me.value != "")
                        CloseDialog(Me);
                }
                return false;
        ...
        close: function (option) {
            ...
            function _t() {
                ...
                if (oForms.length > 0) {
                    _CurrentPage = oForms[oForms.length - 1];
                } else {
                    if (_PageType == "PlanBook")
                        _CurrentPage = "PlanBook";
                    else if (_PageType == "PlanViews")
                        _CurrentPage = "PlanViews";
                    else if (_PageType == "PrintExport")
                        _CurrentPage = "PrintExport";
                    else
                        _CurrentPage = "DefaultView";
                }
    ...
    function SetFormData(event, data) {
        event.dataContainer.innerHTML = data;       
        $(".nswindowContainer").find("#iHold").last().load(function () {
            $(".loader").fadeOut("slow");         
        });
    }
