...
define([], function () {
    ...
    var OdataQueryBuilder = function () {
        var OdataQueryBuilder, FilterObj, Helpers;
            ...
            this.FilterSettings = {
                ...
                loadFromJson: function (filterSettings) {
                    ...
                    loadPrecedenceGroup = function (precedenceGroup) {
                        ...
                        group = new OdataQueryBuilder.PrecedenceGroup();
                    ...
                    loadFilterObj = function (currentFilter) {
                        ...
                        newFilterClause = new OdataQueryBuilder.FilterClause();
        ...
        OdataQueryBuilder.prototype = {
            ...
            saveLocal: function (key) {
                ...
                json = this.toJson();
                storageKey = key || 'OdataQueryBuilderData.StorageKey';

                localStorage.setItem(storageKey, json);
            }
        };

        OdataQueryBuilder.loadLocal = function (storageKey) {
            var actualKey, jsonStr, json, OdataQueryBuilderDataObj, key;

            actualKey = storageKey || 'OdataQueryBuilderData.StorageKey';
            ...
            OdataQueryBuilderDataObj = new OdataQueryBuilder(json.baseUri);
            OdataQueryBuilderDataObj.currentHashRoute = json.currentHashRoute;

            if (json.OrderBySettings !== null) {
                for (key in json.OrderBySettings) {
                    if (json.OrderBySettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.OrderBySettings[key] = json.OrderBySettings[key];
                    }
                }
            }
            ...
            if (json.TopSettings !== null) {
                for (key in json.TopSettings) {
                    if (json.TopSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.TopSettings[key] = json.TopSettings[key];
                    }
                }
            }
            ...
            if (json.SkipSettings !== null) {
                for (key in json.SkipSettings) {
                    if (json.SkipSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.SkipSettings[key] = json.SkipSettings[key];
                    }
                }
            }
            ...
            if (json.SelectSettings !== null) {
                for (key in json.SelectSettings) {
                    if (json.SelectSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.SelectSettings[key] = json.SelectSettings[key];
                    }
                }
            }
            ...
            if (json.ExpandSettings !== null) {
                for (key in json.ExpandSettings) {
                    if (json.ExpandSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.ExpandSettings[key] = json.ExpandSettings[key];
                    }
                }
            }
            ...
            if (json.FormatSettings !== null) {
                for (key in json.FormatSettings) {
                    if (json.FormatSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.FormatSettings[key] = json.FormatSettings[key];
                    }
                }
            }
            ...
            if (json.InlineCountSettings !== null) {
                for (key in json.InlineCountSettings) {
                    if (json.InlineCountSettings.hasOwnProperty(key)) {
                        OdataQueryBuilderDataObj.InlineCountSettings[key] = json.InlineCountSettings[key];
                    }
                }
            }

            if (json.FilterSettings !== null) {
                OdataQueryBuilderDataObj.FilterSettings.loadFromJson(json.FilterSettings);
            }

            return OdataQueryBuilderDataObj;
        };
        ...
        OdataQueryBuilder.PrecedenceGroup = function (filterClause) {
            if (!filterClause instanceof OdataQueryBuilder.FilterClause) {
                throw 'filterClause must be of type OdataQueryBuilder.FilterClause!';
            }
        ...
        OdataQueryBuilder.PrecedenceGroup.prototype = {
            clauses: [],
            isEmpty: function () {
        ...
        OdataQueryBuilder.literal = function (stringLiteral) {
            return "'" + stringLiteral.toString() + "'";
        };

        OdataQueryBuilder.datetime = function (datetime) {
            return "datetime'" + datetime + "'";
        };

        OdataQueryBuilder.decimal = function (decimal) {
            return decimal + 'm';
        };

        OdataQueryBuilder.guid = function (guid) {
            return "guid'" + guid + "'";
        };

        OdataQueryBuilder.single = function (single) {
            return single + 'f';
        };

        OdataQueryBuilder.double = function (double) {
            return double + 'd';
        };

        OdataQueryBuilder.Concat = function (value1, value2) {
            this.LeftSide = value1;
            this.RightSide = value2;
            return this;
        };

        OdataQueryBuilder.Concat.prototype = {
            LeftSide: null,
            RightSide: null,
            toString: function () {
                var that = this;
        ...
        OdataQueryBuilder.FilterClause = function (property) {
            this.Property = property;
            this.Components = [];
            return this;
        };

        OdataQueryBuilder.FilterClause.prototype = {
            Property: null,
            Value: null,
            IsClauseEmpty: true,
