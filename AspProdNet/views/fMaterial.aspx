<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fMaterial.aspx.cs" Inherits="AspProdNet.views.fMaterial" %>
...
<body>
    <form id="form1" runat="server" class="frmMaster">
        ...
        <div class="col-xs-12 col-sm-6">
            <span id="spnMatId" class="pull-right" hidden="hidden">-1</span>
            <label>Name:</label>
    ...
    <script src="../Scripts/views/jMaterial.js"></script>
</body>
</html>
